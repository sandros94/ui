...
export const theme = {
  slots: {
    root: 'w-full bg-[--ui-bg]/75 backdrop-blur text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-800 -mb-px text-xl',
    container: 'flex items-center justify-between gap-3 h-[--s94-ui-header] max-w-[90rem]',
    ...
    slideoverOverlay: 'bg-[--ui-bg]/75 dark:bg-[--ui-bg]/75',
    slideoverContent: 'bg-[--ui-bg] dark:bg-[--ui-bg]',
    slideoverHeader: 'w-full h-[--s94-ui-header] inline-flex items-center justify-between border-b border-gray-200 dark:border-gray-800 text-2xl',
    slideoverBody: 'size-full flex flex-col justify-around text-xl',
    slideoverFooter: 'w-fit mx-auto text-xl min-h-[--s94-ui-header]',
    socials: 'w-fit',
  },
  variants: {
    variant: {
      transparent: {
        root: 'border-0 bg-[--ui-bg]/0 backdrop-blur-none',
      },
      faded: {
        root: 'border-0 bg-[--ui-bg]/0 backdrop-blur-none bg-gradient-to-b from-[--ui-bg]/75 to-transparent',
      },
    },
    sticky: {
      true: {
