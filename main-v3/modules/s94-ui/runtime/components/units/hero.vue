...
export const theme = {
  slots: {
    ...
    headline: 'text-2xl font-bold tracking-tight text-[var(--ui-text-highlighted)]',
    subhead: '',
    img: '',
  },
  variants: {
    variant: {
      horizontal: {
        ...
        cta: 'mt-12',
        headline: 'sm:text-3xl',
        subhead: 'text-lg text-[var(--ui-text-toned)]',
      },
      vertical: {
        base: 'prose dark:prose-invert py-16 sm:py-24 relative mx-auto max-w-full',
        content: 'text-center',
